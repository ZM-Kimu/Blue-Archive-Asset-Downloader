...
internal sealed class FlatBufferBuilderResolver
{
    private readonly IReadOnlySet<string> _typeFullNames;

    public FlatBufferBuilderResolver(KnownTypeCatalog knownTypes)
    {
        _typeFullNames = knownTypes.TypeFullNames;
    }

    public ResolvedMemberSet ApplyFlatBufferTableAdjustments(
        TypeDefinition type,
