...
internal sealed partial class MxFieldFamilyAdjustment
{
    ...
    public MxFieldFamilyAdjustment(KnownTypeCatalog knownTypes, TypeDefinition type, ResolvedMemberSet members)
    {
