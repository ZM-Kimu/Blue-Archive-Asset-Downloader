...
internal sealed class YldaMemoryPackFormatterResolver
{
    ...
    public YldaMemoryPackFormatterResolver(YldaKnownTypeCatalog knownTypes)
    {
    ...
    public YldaResolvedMemberSet ApplyMemoryPackAdjustments(
        TypeDefinition type,
        string safeTypeName,
