...
internal sealed partial class YldaReferenceModelAdjustment
{
    ...
    public YldaReferenceModelAdjustment(
        YldaKnownTypeCatalog knownTypes,
        TypeDefinition type,
        string safeTypeName,
        ...
        YldaResolvedMemberSet members)
    {
        ...
        parsedSafeGeneric = YldaResolutionUtilities.ParseGenericType(safeTypeName);
    ...
    public YldaResolvedMemberSet Apply()
    {
        ...
        return new YldaResolvedMemberSet(relationships, adjustedFields, adjustedProperties, adjustedEvents, adjustedMethods);
    }
