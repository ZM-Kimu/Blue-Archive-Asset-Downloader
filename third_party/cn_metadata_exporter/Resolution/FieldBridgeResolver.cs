...
internal sealed class FieldBridgeResolver
{
    ...
    public FieldBridgeResolver(KnownTypeCatalog knownTypes)
    {
        ...
        ResolvedMemberSet members)
    {
        ...
        var adjustedFields = fields.Select(field =>
        {
            ...
            desiredType ??= ResolutionUtilities.BackingFieldPropertyName(field.Identifier) is { } backingPropertyName
