...
internal sealed partial record class GameInitializer : DefaultGameInitializer
{
	...
	public IGameLoadProgress? LoadProgress { get; }

	public GameInitializer(PlatformGameStructure? platformStructure, PlatformGameStructure? mixedStructure, FileSystem fileSystem, UnityVersion defaultVersion, UnityVersion targetVersion, IGameLoadProgress? loadProgress = null)
