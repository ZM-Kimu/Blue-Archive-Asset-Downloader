...
JP_DATABASE_INDEX_SOURCE_SPEC = DatabaseIndexSourceSpec(
...
class JpDbCharacterIndexSourceProfile:
    def load(
        self,
        loader: CharacterIndexSourceLoader,
    ) -> CharacterIndexSources:
        return loader.load_database_index_sources(JP_DATABASE_INDEX_SOURCE_SPEC)
